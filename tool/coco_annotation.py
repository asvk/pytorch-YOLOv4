...
"""hyper parameters"""
json_file_path = '/storage/datasets/mscoco/annotations/stuff_train2017.json'
images_dir_path = 'mscoco/train2017/'
output_path = '../data/train.txt'
# json_file_path = '/storage/datasets/mscoco/annotations/stuff_val2017.json'
# images_dir_path = 'mscoco/val2017/'
